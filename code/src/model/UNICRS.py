...
class UNICRS():
    ...
    def __init__(self, seed, kg_dataset, debug, tokenizer_path,
        ...
        self.tokenizer_path = '/data/qinpeixin/huggingface/DialoGPT-small/'
        self.text_tokenizer_path = f"{text_tokenizer_path}"
        self.text_tokenizer_path = '/data/qinpeixin/huggingface/roberta-base/'
        
        self.text_encoder = f"{text_encoder}"
        self.text_encoder = '/data/qinpeixin/huggingface/roberta-base/'
        self.model_path = f"{model}"
        self.model_path = '/data/qinpeixin/huggingface/DialoGPT-small/'
